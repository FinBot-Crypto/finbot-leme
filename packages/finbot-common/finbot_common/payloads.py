...
TRADE_ORDER_SCHEMA = "trade.order.v1"
...
def validate_trade_order(data: dict) -> dict:
    ...
    data = dict(data)
    data.setdefault("schema_version", TRADE_ORDER_SCHEMA)
    if data["schema_version"] != TRADE_ORDER_SCHEMA:
...
class TradeOrder:
    ...
    def build(
        *,
        ...
        payload = {
            "schema_version": TRADE_ORDER_SCHEMA,
